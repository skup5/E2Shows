...
\section{Závěr}
	\paragraph{}
	Aplikace plně splňuje zadání. Byla otestována na skutečném telefonu s~Androidem 4.3 a na dvou virtuálních s Androidem 4.1 a 5.1. Na všech běží bezproblémově. Při testování byly ošetřeny veškeré odhalené chyby. Aplikace by tedy neměla při běhu zamrznout či se sama ukončit kvůli chybě.
	
	Aplikace by se mohla rozšířit o offline režim přehrávání uživatelem vybraných záznamů nebo možnost označit či přímo uložit oblíbené nahrávky.
\end{document}